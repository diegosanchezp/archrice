...
setsid --fork alacritty --title "Notes" -e zsh -c "nvim -c ':colorscheme github_light_tritanopia' ~/Documents/ObsidianVaults/diegos-knowledge/rutinas-diarias/rutinas-diarias.md && exec zsh"
